    ...
    <div className="min-h-screen flex items-center justify-center px-6 bg-[#1a1614]">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <p className="font-body text-[#9a8e7e] mt-2">
        ...
        <form onSubmit={handleSubmit} className="card-warm p-8 space-y-5">
          ...
          <div>
            <label className="block font-ui text-sm text-[#9a8e7e] mb-2">
              Confirm password
            </label>
            <input
              type="password"
          ...
          <p className="font-ui text-xs text-[#9a8e7e] text-center">
            By signing up, you agree to use Lengua for language learning.
          </p>
        </form>

        <p className="text-center font-ui text-sm text-[#9a8e7e] mt-6">
          Already have an account?{' '}
          <Link to="/login" className="text-[#d4a853] hover:text-[#f0e8d8] transition-colors">
            Sign in
          </Link>
        </p>
      </div>
